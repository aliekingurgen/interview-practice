...
public class PathsWithSum {
	...
	public static int countPathsWithSum(TreeNodeR root, int targetSum) {
		return countPathsWithSum(root, targetSum, 0, new HashMap<Integer, Integer>());
	}
	
	public static int countPathsWithSum(TreeNodeR node, int targetSum, int runningSum, HashMap<Integer, Integer> pathCount) {
